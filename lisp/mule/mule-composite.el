;;; mule-composite.el --- support character composition
...
This function is the default value of `compose-chars-after-function'."
  (let ((tail (get-char-table (char-after pos) composition-function-table))
	pattern func result)
    (when tail
      (save-match-data
	(save-excursion
...
(make-obsolete 'decompose-composite-char 'char-to-string
	       ;;"21.1"
	       )


;;; mule-composite.el ends here
