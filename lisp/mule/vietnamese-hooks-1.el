;;; vietnamese-hooks-1.el --- pre-loaded support for Vietnamese, part 1.
...
(make-charset 'vietnamese-lower "VISCII lower (Vietnamese)"
	      '(registry "VISCII1.1"
		dimension 1
		chars 96
		final ?1
...
(make-charset 'vietnamese-upper "VISCII upper (Vietnamese)"
	      '(registry "VISCII1.1"
		dimension 1
		chars 96
		final ?2
...
(modify-syntax-entry 'vietnamese-lower "w")
(modify-syntax-entry 'vietnamese-upper "w")

(define-category ?v "Vietnamese character.")
(modify-category-entry 'vietnamese-lower ?v)
(modify-category-entry 'vietnamese-upper ?v)
