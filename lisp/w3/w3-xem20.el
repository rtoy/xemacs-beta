;;; w3-xem20.el,v --- XEmacs 20.0 with Mule specific functions
;; Author: MORIOKA Tomohiko
;; Created: 1996/06/14 16:44:59
;; Version: 1.1
...
(defun w3-inhibit-code-conversion (proc buf)
  ...
  (save-excursion
    (set-buffer buf)
    (setq mc-flag nil))
  (set-process-input-coding-system proc url-mule-no-coding-system)
  (set-process-output-coding-system proc url-mule-no-coding-system))
