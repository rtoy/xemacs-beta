...
;;;***

;;;### (autoloads (batch-force-update-one-directory batch-update-one-directory batch-update-directory batch-update-autoloads update-autoload-files update-autoloads-from-directory update-autoloads-here update-file-autoloads generate-file-autoloads) "autoload" "lisp/autoload.el")
...
`update-autoload-files' instead." t nil)
...
If FORCE is non-nil, always save out the autoload files even if unchanged." nil nil)
...
(autoload 'batch-force-update-one-directory "autoload" "\
Update the autoloads for a single directory on the command line.
Runs `update-file-autoloads' on each file in the given directory, and must
