...
(defvar forms-use-extents (fboundp 'set-extent-property) ; XEmacs 19.9+
  "*Non-nil means: use XEmacs/Lucid Emacs extents.
...
(defvar forms-rw-face (if (string-match "XEmacs" emacs-version)
			  'forms-field-face
			'region)
...
(defvar forms--lemacs-p (string-match "XEmacs" emacs-version))
