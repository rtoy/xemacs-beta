...
;; XEmacs fix:
(defvar dired-emacs-19-p (not (equal (substring emacs-version 0 2) "18")))
...
(defvar dired-chown-program
  (purecopy
   (if (memq system-type '(dgux-unix hpux usg-unix-v silicon-graphics-unix irix))
       "chown" "/etc/chown"))
...
(defun dired-find-file-other-window ()
  ...
  (interactive)
  (let ((find-file-run-dired t)) ;; XEmacs
...
;; #### called dired-do-flagged-delete in FSF
