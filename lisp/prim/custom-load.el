...
(put 'processes 'custom-loads '("background" "comint" "rlogin" "shell" "cus-edit" "term" "executable" "gnuserv" "ispell" "metamail" "rcompile" "passwd"))
...
(put 'unix 'custom-loads '("rlogin" "shell" "term" "sh-script"))
(put 'x 'custom-loads '())
