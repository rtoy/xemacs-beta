...
#else
#define FRAME_THEORETICAL_TOP_TOOLBAR_HEIGHT(f) 0
#endif
...
#else
#define FRAME_THEORETICAL_TOP_TOOLBAR_BORDER_WIDTH(f)   0
#endif
...
#else
#define FRAME_REAL_TOP_TOOLBAR_HEIGHT(f)        0
#endif
...
#else
#define FRAME_REAL_TOP_TOOLBAR_BORDER_WIDTH(f)  0
#endif
...
#else
#define FRAME_REAL_TOP_TOOLBAR_BOUNDS(f)        0
#endif
...
#else
#define FRAME_TOP_INTERNAL_BORDER_START(f)      0
#define FRAME_TOP_INTERNAL_BORDER_END(f)          0
#endif
