...
/* #define PATH_LOADSEARCH "/usr/local/lib/xemacs-19.14/lisp" */
/* #define PATH_EXEC "/usr/local/lib/xemacs-19.14/i486-unknown-linux2.0.0" */
/* #define PATH_DATA "/usr/local/lib/xemacs-19.14/etc" */
/* #define PATH_LOCK "/usr/local/lib/xemacs/lock" */
/* #define PATH_INFO "/usr/local/lib/xemacs-19.14/info" */
